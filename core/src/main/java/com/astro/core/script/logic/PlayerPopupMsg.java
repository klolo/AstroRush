package com.astro.core.script.logic;
...
public class PlayerPopupMsg {
    ...
    class MessagesColors {
        ...
        final Color INFO = new Color(1, 1, 0, 1);
    ...
    public void show(final OrthographicCamera cam, float delta) {
        if (currentMsg != null) {
            ...
            Color currentColor = new MessagesColors().INFO;
