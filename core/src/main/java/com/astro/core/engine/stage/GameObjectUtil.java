...
public class GameObjectUtil {
    ...
    public ArrayList<IGameObject> sortObjectsByLayer(final ArrayList<IGameObject> gameObjects) {
        final HashMap<String, LinkedList<IGameObject>> sortedObjectMap = new HashMap<>();
        ...
        final ArrayList<IGameObject> sortedObjects = new ArrayList<>(gameObjects.size());
