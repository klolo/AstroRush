package com.astro.game.overlap_runtime;

import com.astro.game.engine.stage.GameObjectUtil;
import com.astro.game.objects.interfaces.IGameObject;
import com.astro.game.overlap_runtime.loaders.*;
...
public class OverlapSceneReader {
    ...
    OverlapSceneReader unsupportedComponent(final ArrayList components) {
        if (components != null && components.size() > 0) {
            LOGGER.error(UNKNOWN_COMPONENT_MSG);
        }
        return this;
    }
